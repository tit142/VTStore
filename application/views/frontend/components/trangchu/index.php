    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             <img style="width: 100%; height: 160px;;" src="public/images/trang-chu-3.jpg">
             <img style="width: 100%; height: 160px;" src="public/images/trang-chu-4.jpg">
         </div>
...
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #E6DFCD;">
        <?php 
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue" style="color: #00000">Tin tức công nghệ</h2>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center m-b-xs-10">
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                <span class="large-text" style="color: #00000">
                                    Miễn phí giao hàng
                                </span>
                                <span class="small-text" style="color: #00000">
