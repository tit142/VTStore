					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Tặng Giáp chân tay Inox</li>
											</ul>
											<ul>
												<li>Tặng Bọc balo chống nước <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Bảo hành 12 tháng tại cửa hàng 1 đổi 1 trong 30 ngày nếu có lỗi nhà sản xuất.</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
