<section class="logo-search">
  <div class="container">
    ...
    <a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/logo-web.png" width="50%"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> (84) 395 971 911
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> truongtittit8@gmail.com
        </div>
      </div>
