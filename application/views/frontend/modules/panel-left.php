<div class="menu-pri">
    <div class="container">
        <div class="panel-left" style="background: #E6DFCD;">
            <!--MOBILE-->
            <nav class="navbar navbar-default hidden-md hidden-lg" role="navigation">
                <div class="container-fluid" style="background-color: #E6DFCD;">
        ...
        <div class="col-md-12 col-lg-12 panel-right hidden-xs text-center" style="background: #E6DFCD;">
