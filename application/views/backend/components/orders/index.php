    ...
    <section class="content-header">
        ...
        <div class="breadcrumb">
            <a class="btn btn-primary btn-sm" href="admin/orders/recyclebin" role="button">
                <span class="glyphicon glyphicon-trash"></span> Đơn hàng đã xóa (<?php $total=$this->Morders->orders_trash_count(); echo $total; ?>)
            </a>
        </div>
    </section>
                                            ...
                                            <?php foreach ($list as $val):
                                                ...
                                                <tr>
													...
													<td class="text-center">
														...
														<span class="glyphicon glyphicon-floppy-save"></span> Lưu đơn
														</a>
													</td>
												</tr>
											<?php endforeach; ?>
