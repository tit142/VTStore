...
<?php
	...
	{
		if($val['orders'] == ((int)$row['orders'] - 1))
		{
			$option_orders.="<option selected value='".((int)$val['orders']+1)."'>Sau - ".$val['name']."</option>";
		}
		else
		{
			$option_orders.="<option value='".((int)$val['orders']+1)."'>Sau - ".$val['name']."</option>";
		}
	}
?>
